...
public class ProjectSecurityConfig {
	...
	private final String instrospectionUri;

	private final String clientId;

	private final String clientSecret;

	public ProjectSecurityConfig(@Value("spring.security.oauth2.resourceserver.opaquetoken.introspection-uri") String instrospectionUri,
		...
		this.instrospectionUri = instrospectionUri;
